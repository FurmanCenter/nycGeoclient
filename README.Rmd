...
The code is copied from this [repo](https://github.com/austensen/geoclient). This repo was copied
over, so that changes can be made by the Furman Center.
